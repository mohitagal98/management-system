...
if (acc_approval_check($_SESSION['user_id'],$conn)==6){
    header("Location:profile.php");
}
?>
    <!DOCTYPE HTML>
                ...
                <div class="card-container">
                    <div class="card">
                        <div class="card-header bg-info">
                            <h5 class="card-title text-light">Information</h5>
                        </div>
                        <div class="card-body">
                            <h4 class="text-info">
                                Your Account is not approved yet,<br>Please contact your College Admin to approve it.
                            </h4>
                        </div>
                        <div class="card-footer bg-light">
                            <form method="get" action="acc_blocked.php">
                                <input type="submit" name="sign_out" value="Sign Out" class="form-control btn btn-info">
                            </form>
                        </div>
                    </div>
                </div>
